(function(){
    ...
    angular
        .module('legislation')
        .controller('AdminLegislationsController', AdminLegislationsController);

    //We inject the dependencies
    AdminLegislationsController.$inject = ['$scope', 'LegislationService'];

    /**
     * Controller in charge of the handling of the item list view
     * */
    function AdminLegislationsController( $scope, LegislationService ){
