(function () {
  ...
  ChangePasswordController.$inject = ['$scope', '$http', 'AuthenticationService', 'PasswordValidator'];

  function ChangePasswordController($scope, $http, AuthenticationService, PasswordValidator) {
    var vm = this;
